...
function generatePrompt(userInput) {
  ...
  return `you are rapGPT. you will create hip hop/rap rhymes based on, but not limited to, the user input. You will need to refer to your knowledge of hip hop/rap in order to create creative rhymes, rather than repeating only the user input.: ${capitalizedUserInput} \n\n rapGPT:`;
}
